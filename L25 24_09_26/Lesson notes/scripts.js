...
item.append(nameElement, priceElement); //-вставляэмо в айтем елементи один за оним
list.insertAdjacentElement ("beforeend", item);
//«Візьми наш контейнер (list), загляни внутрь в самый конец 
// (beforeend) і додай туди щойно створений товар (item)».
};
...
const createProduct = (id, name, price) => {const createProduct = (id, name, price) => { ...
};
